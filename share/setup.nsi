...
!define URL http://www.DigitalCredits.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/DigitalCredits.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\DigitalCredits-qt.exe
...
OutFile DigitalCredits-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/DigitalCredits-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/DigitalCreditsd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\DigitalCredits.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\DigitalCredits-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "DigitalCredits"
